...
def test_create_booking_delete(create_token):
    ...
    assert create_response_data["booking"]["firstname"] == "Saurabh", "First name is incorrect"
    assert create_response_data["booking"]["lastname"] == "Mehta", "Last name is incorrect"
